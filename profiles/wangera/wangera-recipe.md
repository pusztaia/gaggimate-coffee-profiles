...
|---|---|
| **17 s körül 6-9 g, végén 41.5-42.5 g, jó íz** | marad a Scale V4 profil |
...
A verziószám **szándékosan V4 maradt**. A meglévő V4 JSON-fájlok tartalma lett felülírva a javított stop-logikával.

**Változatlan fájlnevek:**

- [`wangera-stable-38s-scale-v4.json`](wangera-stable-38s-scale-v4.json) – 94.0 °C
- [`wangera-stable-38s-945c-scale-v4.json`](wangera-stable-38s-945c-scale-v4.json) – 94.5 °C
...
A korábbi V4 logika így működött:
...
A javított V4 logika kétlépcsős:
...
| Eredmény | Következő lépés |
|---|---|
| **41.5-42.5 g körül megáll, szederes/krémes, jó** | a Scale V4 profil helyes, nincs teendő |
...
| **42 g körüli hozam, száraz/naturalos** | a Cream Finish targetet csökkentsd **40.0 g-ra**, vagy használj 94.0 °C-os V4 profilt |

---

## V4 gyors ellenőrzőlista
...
4. A betöltött fájl neve továbbra is `...scale-v4.json`.
