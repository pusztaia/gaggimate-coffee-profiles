...
| Kávé | Hőmérséklet |
|---|---:|
| Kenya Wangera (V2 főprofil) | 94.5 °C |
...
2. **Hozam** (g) – a mérleg mutatja (V2 profilnál automatikus stop)
...
| Dátum | |
| Kávé | |
| Profil | JSON fájlnév és verzió (V1/V2) |
| Dózis | g |
| Hozam | g |
| Idő | s |
| Hőmérséklet | °C |
...
## 8. V1 vs V2 dial-in különbségek
